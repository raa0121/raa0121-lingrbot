...
$VAC12 = JSON.parse(open("https://api.atnd.org/events/?event_id=33746&format=json", :ssl_verify_mode => OpenSSL::SSL::VERIFY_NONE).read)["events"][0]["description"]
#$VAC13=open("https://raw.github.com/osyo-manga/vim_advent_calendar2013/master/README.md").read
$VAC13 = JSON.parse(open("https://api.atnd.org/events/?event_id=45072&format=json", :ssl_verify_mode => OpenSSL::SSL::VERIFY_NONE).read)["events"][0]["description"]
